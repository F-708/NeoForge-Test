...
public class ModItemProperties {
    public static void addCustomItemProperties() {
        ItemProperties.register(ModItems.TONGSHOTIRON.get(), ResourceLocation.fromNamespaceAndPath(ExampleMod.MODID, "state"),
        ...
        ItemProperties.register(ModItems.STICKSHOTIRON.get(), ResourceLocation.fromNamespaceAndPath(ExampleMod.MODID, "state"),
                ((stack, level, entity, seed) -> switch (stack.get(ModDataComponents.FORGE_STATE)){
                    case 0 -> 0f;
                    case 1 -> 0.0f;
                    case 2 -> 0.1f;
