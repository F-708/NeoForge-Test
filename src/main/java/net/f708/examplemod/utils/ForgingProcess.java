...
//
//import static net.f708.examplemod.TEST.ModRecipes.FORGING;
//import static net.f708.examplemod.TEST.ModRecipes.RECIPE_TYPES;
...
//
//        ForgingInput inputMain = new ForgingInput(mainHand, result);
//        Optional<RecipeHolder<ForgingRecipe>> optional = recipeManager.getRecipeFor(
//                FORGING.get(),inputMain, level
//        );
//
//
//
...
//                            ItemStack theResult = optional
//                                    .map(RecipeHolder::value)
//                                    .map(e -> e.assemble(inputMain, level.registryAccess()))
//                                    .orElse(ItemStack.EMPTY);
//                            inventory.setItem(slot, theResult);
//
//
